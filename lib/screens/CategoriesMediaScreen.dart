...
import '../screens/SubCategoriesNavHeader.dart';
          ...
          child: Column(
            children: <Widget>[
              Consumer<CategoryMediaScreensModel>(
                builder: (context, catsMediaModel, child) {
                  return Visibility(
                      visible: catsMediaModel.subCategoriesList.length > 0,
                      child: subCategoriesNavHeader());
                },
              ),
              Expanded(
                  child: Container(
