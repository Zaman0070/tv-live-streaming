...
class RadioRecordingsScreen extends StatefulWidget {
  static const routeName = "/RadioRecordingsScreen";
  RadioRecordingsScreen();

  @override
  RadiosScreenRouteState createState() => new RadiosScreenRouteState();
}

class RadiosScreenRouteState extends State<RadioRecordingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Radios> items = [];
    RadioRecordingsModel radioModel =
        Provider.of<RadioRecordingsModel>(context);
    ...
    return InkWell(
                  ...
                  return showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        content: const Text(
                            "Do you wish to delete this recording? This action cannot be undone."),
                        actions: <Widget>[
                          FlatButton(
      ...
      onTap: () {
        ...
        Provider.of<AudioPlayerModel>(context, listen: false)
            .preparerecordedradioplayer(media);
