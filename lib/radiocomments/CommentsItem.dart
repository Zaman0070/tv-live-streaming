...
import '../comments/MediaRepliesScreen.dart';
...
class _CommentsItemState extends State<CommentsItem> {
  ...
  reportPost(int id, int index, String reason) {
    Provider.of<RadioCommentsModel>(widget.context, listen: false)
                        ...
                        children: <Widget>[
                          ...
                          Visibility(
                            ...
                            child: InkWell(
                              ...
                              onTap: () {
                                Provider.of<RadioCommentsModel>(context,
                                        listen: false)
