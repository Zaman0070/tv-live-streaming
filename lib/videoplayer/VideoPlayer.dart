...
import '../videoplayer/YoutubePlayer.dart';
...
class _VideoPlayerState extends State<VideoPlayer>
  ...
  Widget buildVideoContainer(Media currentMedia) {
    ...
    } else if (currentMedia.videoType == "vimeo_video") {
      return Container(
        height: double.infinity,
        child: VimeoPlayer(
          videoId: currentMedia.streamUrl,
        ),
      );
    }
    {
        ...
        return Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Visibility(
                visible: widget.currentMedia.videoType == "mp4_video",
                child: InkWell(
                  onTap: () {
                    Downloads downloads =
