...
import 'package:newsextra/livestreamcomments/CommentsItem.dart';
import 'package:newsextra/livestreamcomments/CommentsMediaHeader.dart';
import 'package:newsextra/livestreamcomments/LiveStreamCommentsModel.dart';
...
class LivestreamsCommentsScreen extends StatefulWidget {
  static String routeName = "/LivestreamCommentsScreen";
  final LiveStreams item;
  final int commentCount;

  LivestreamsCommentsScreen({Key key, this.item, this.commentCount})
      : super(key: key);
...
class _CommentsScreenState extends State<LivestreamsCommentsScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
        create: (context) => LiveStreamCommentsModel(
...
class CommentsSection extends StatelessWidget {
  ...
  final LivestreamsCommentsScreen widget;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        Navigator.pop(
            context,
            Provider.of<LiveStreamCommentsModel>(context, listen: false)
                .totalPostComments);
        return false;
      },
      child: Scaffold(
        ...
        body: Column(
          children: <Widget>[
            ...
            userdata == null
                ...
                : Consumer<LiveStreamCommentsModel>(
...
class CommentsLists extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var commentsModel = Provider.of<LiveStreamCommentsModel>(context);
            ...
            return Container(
              ...
              child: Center(
                  child: RaisedButton(
                      ...
                      onPressed: () {
                        Provider.of<LiveStreamCommentsModel>(context,
                                listen: false)
                            .loadMoreComments();
                      })),
            );
