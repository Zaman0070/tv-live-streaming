...
import 'package:newsextra/comments/MediaRepliesModel.dart';
...
class MediaRepliesScreen extends StatefulWidget {
  static String routeName = "/MediaRepliesScreen";
  final Object item;
  final int repliesCount;

  MediaRepliesScreen({Key key, this.item, this.repliesCount}) : super(key: key);

  @override
  _RepliesScreenState createState() => _RepliesScreenState();
}

class _RepliesScreenState extends State<MediaRepliesScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
        create: (context) => MediaRepliesModel(context,
...
class RepliesSection extends StatelessWidget {
  ...
  final MediaRepliesScreen widget;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        Navigator.pop(
            context,
            Provider.of<MediaRepliesModel>(context, listen: false)
                .totalCommentsReply);
        return false;
      },
      child: Scaffold(
...
class RepliesLists extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var repliesModel = Provider.of<MediaRepliesModel>(context);
